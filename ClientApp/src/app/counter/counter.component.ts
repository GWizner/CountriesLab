...
export class CounterComponent {
  ...
  public countries: Country[] = [{ name: "Egypt", officialLanguage: "Arabic", primaryColor: "red" },
  ...
  public OnClickChangeCountry() {
    let countryFromUser: string | null = prompt('Please enter the name of the country')
